...
contract LRK {
    ...
    address[16] private LRK_CONTRACT_ADDRESS = [
        0x0000000000000000000000000000000000000000,
        0x9ecEA68DE55F316B702f27eE389D10C2EE0dde84,
        0x1bB5bf909d1200fb4730d899BAd7Ab0aE8487B0b,
        0xb929Baa8147C86025b04974EF39492185A791aec,
        0x57BD34512C5b8FbfDbB6A35f7FF1c2f5AD32F987,
        0xAA31967fa6Cb809f9c1E89A903Ce0FBa6e100127,
        0xba260dDbfC1B037A1D493a43061c62504cf3D172,
        0xEb5eF7cc8E8FBe02180082983529A263F14bDa85,
        0xd7F18e09072a51B53285854d2E817a2D2Dbb64d0,
        0xD9b4B24e08463B339fFf3589f02cf757D51869B9,
        0x69021b10BaaBe49023a379E94c8B8F387196a5Fc,
        0x03b43Af3e1B61E50B857B3c28c99eFEf17B37eB2,
        0xFAC8d14dba5dff733F084c534964717b997813D2,
        0xD7d3433e33d26992468862E23c418F5f3dBd344d,
        0x70725BEFE6fF762371F2b4160d8201a10b20195F,
        0xEAa2BA969827e60215E691a8B7eD98F0E1Ea4103
    ];
    
 //   mapping(uint8 => address) private LRK_ARTICLE_ADDRESS_MAP;
  //  LRK_ARTICLE_ADDRESS_MAP["1"] = 0x9ecEA68DE55F316B702f27eE389D10C2EE0dde84;
...
// #############################
    ...
    function read_law(uint8 _number) public view returns (string memory) {
        uint8 _article = getArticleNumFromLaw(_number);
        address _addr = LRK_CONTRACT_ADDRESS[_article];
    ...
    function read_test(uint8 _number) public view returns (string memory){
        return LRK_LAWS(0x1bB5bf909d1200fb4730d899BAd7Ab0aE8487B0b).get_laws(_number);
    }
