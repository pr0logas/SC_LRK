...
contract LRK {
    ...
    constructor() {
        ...
        LRK_ARTICLE_ADDRESS_MAP[2] = 0x1bB5bf909d1200fb4730d899BAd7Ab0aE8487B0b;
...
// #############################
    ...
    function read_law(uint8 _number) public view returns (string memory) {
        uint8 article = getArticleNumFromLaw(_number);
        address _addr = LRK_ARTICLE_ADDRESS_MAP[article];
        uint8 test = 5;
        //return _addr;
        
        return LRK_LAWS(LRK_ARTICLE_ADDRESS_MAP[test]).get_laws(_number);
